            ...
            while (true)
            {
                ...
                switch (path)
                {
                    ...
                    case 1:
                        ...
                        Console.WriteLine("1 - приспособленность соответствует натуральному значению бинарного кода");
                        Console.WriteLine("2 - приспособленность вычисляется как квадратичная функция");
                        Console.WriteLine("3 - случайное задание приспособленностей");
                        int AlgorithmPath = -1;
                        ...
                        for (int i = 0; i < Math.Pow(2, L); ++i)
                        {
                            ...
                            {
                                list.Add(rnd.Next(0, Convert.ToInt32(Math.Pow(2, L))).ToString());
                            }
                    ...
                    case 2:
                        if (binary_encodings.Count > 0)
                        {
                            ...
                            for (int i = 0; i < n; ++i)
                            {
                                ...
                                if (locality.Count > 0)
                                {
                                    // Выбор случайного элемента из окрестности
